// Generated by dojo-bindgen on Sat, 22 Feb 2025 12:08:25 +0000. Do not modify this file manually.
using System;
...
public class Game : MonoBehaviour {
    ...
    // Call the `check` system with the specified Account and calldata
    // Returns the transaction hash. Use `WaitForTransaction` to wait for the transaction to be confirmed.
    public async Task<FieldElement> check(Account account) {
        List<dojo.FieldElement> calldata = new List<dojo.FieldElement>();
