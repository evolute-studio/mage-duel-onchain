...
slot deployments create --team evolute dev-evolute-duel katana --dev --dev.no-fee
sozo build --profile testing 
sozo migrate --profile testing
slot deployments create --team evolute dev-evolute-duel torii --config torii_config_testing.toml #--version 1.5.4-preview.0 
