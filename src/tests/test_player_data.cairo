...
//         let player_data = PlayerDataTrait::validate_player_and_get_data(@board, invalid_player,
//         world);
...
//         assert!(data1_unwrap.joker_number == data2_unwrap.joker_number, "Joker numbers should be
//         consistent");
