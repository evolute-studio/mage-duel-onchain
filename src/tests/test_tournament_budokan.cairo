...
mod tests {
    ...
    use tournaments::components::models::tournament::{
        ...
        Registration, m_Registration, Metadata, GameConfig,
        EntryFee, PrizeType,
    };
    use tournaments::components::models::game::{
        m_TokenMetadata, m_GameMetadata, m_GameCounter,
        m_SettingsDetails, m_Score,
    };
    ...
    fn TOURNAMENT_DESCRIPTION() -> ByteArray  {"Integration tournament test"}
    ...
    fn test_create_tournament_basic() {
        ...
        let tournament = contracts.tournament.create_tournament(
            admin,
    ...
    fn test_enter_tournament_basic() {
        ...
        let (token_id, entry_number) = contracts.tournament.enter_tournament(
            tournament.id,
            'player1',
            player1,
            Option::None
    ...
    fn test_enter_tournament_with_entry_fee() {
        ...
        // Enter tournament as player1
        testing::set_contract_address(player1);
        let (_token_id, entry_number) = contracts.tournament.enter_tournament(
            tournament.id,
            'player1',
            player1,
            Option::None
    ...
    fn test_multiple_players_enter_tournament() {
        ...
        // Enter as player1
        testing::set_contract_address(player1);
        let (_, entry1) = contracts.tournament.enter_tournament(
            tournament.id, 'player1', player1, Option::None
        );

        // Enter as player2
        testing::set_contract_address(player2);
        let (_, entry2) = contracts.tournament.enter_tournament(
            tournament.id, 'player2', player2, Option::None
        );

        // Enter as player3
        testing::set_contract_address(player3);
        let (_, entry3) = contracts.tournament.enter_tournament(
            tournament.id, 'player3', player3, Option::None
        );
    ...
    fn test_submit_score() {
        ...
        testing::set_contract_address(player1);
        let (token_id, _) = contracts.tournament.enter_tournament(
            tournament.id, 'player1', player1, Option::None
        );
    ...
    fn test_get_registration() {
        ...
        // Get registration
        let registration = contracts.tournament.get_registration(contracts.tournament.contract_address, token_id);
        assert!(registration.tournament_id == tournament.id, "Registration should match tournament");
    ...
    fn test_tournament_id_for_token() {
        ...
        let retrieved_tournament_id = contracts.tournament.get_tournament_id_for_token_id(
            contracts.tournament.contract_address, token_id
        );
