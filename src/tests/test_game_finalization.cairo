...
//         assert!(updated_player1.balance == 1000 + blue_points.into(), "Player1 balance
//         incorrect");
//         assert!(updated_player2.balance == 1000 + red_points.into(), "Player2 balance
//         incorrect");
...
//         assert!(updated_player1.balance == 1000 + red_points.into(), "Player1 balance
//         incorrect");
//         assert!(updated_player2.balance == 1000 + blue_points.into(), "Player2 balance
//         incorrect");
//     }
...
//         let blue_total = board.blue_score.0 + board.blue_score.1 + (joker_number1.into() *
//         joker_price.into());
//         let red_total = board.red_score.0 + board.red_score.1 + (joker_number2.into() *
//         joker_price.into());

//         // Player1 is blue, so should get blue_total points
//         assert!(final_player1.balance == initial_balance1 + blue_total.into(), "Player1 should
//         get blue points");
//         assert!(final_player2.balance == initial_balance2 + red_total.into(), "Player2 should get
//         red points");
//     }
