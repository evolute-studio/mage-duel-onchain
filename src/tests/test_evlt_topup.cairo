...
mod tests {
    ...
    fn deploy_contracts() -> (ITopUpDispatcher, IEvltTokenDispatcher, IEvltTokenProtectedDispatcher, ITopUpAdminDispatcher) {
    ...
    fn test_multiple_topups_same_user() {
        ...
        // Check total topups
        assert!(topup.get_total_topups(user_address) == expected_balance, "Total topups should match balance");
    }
