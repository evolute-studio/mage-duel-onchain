...
mod tests {
    ...
    use evolute_duel::models::{
        tournament::{
            ...
            TournamentStateModel, m_TournamentStateModel,
    ...
    use tournaments::components::models::{
        tournament::{
            ...
            EntryFee, EntryRequirement, m_Leaderboard, m_PlatformMetrics,
            m_TournamentTokenMetrics, m_PrizeMetrics, m_EntryCount, m_Prize,
            m_Token, m_TournamentConfig, m_PrizeClaim, m_QualificationEntries,
        },
        game::{
            TokenMetadata, m_TokenMetadata, 
            GameMetadata, m_GameMetadata,
            GameCounter, m_GameCounter, m_Score, m_Settings, m_SettingsDetails,
            m_SettingsCounter,
        },
    ...
    //     assert!(fetched_tournament.metadata.name == 'EVLT Tournament', "Tournament name should match");
