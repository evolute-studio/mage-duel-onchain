...
use evolute_duel::{models::game::Board, events::PlayerNotInGame, types::packing::PlayerSide};
...
pub impl PlayerDataImpl of PlayerDataTrait {
    fn get_player_data(
        board: @Board, player: ContractAddress, mut world: dojo::world::WorldStorage,
    ) -> Option<PlayerData> {
