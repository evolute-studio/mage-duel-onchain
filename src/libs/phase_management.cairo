...
pub impl PhaseManagementImpl of PhaseManagementTrait {
    ...
    fn emit_phase_started_event(
        transition_data: PhaseTransitionData,
        mut world: dojo::world::WorldStorage,
    ) {
    ...
    fn transition_to_phase(
        ...
        Self::update_board_phase(
            transition_data.board_id,
            transition_data.new_game_state,
            world,
        );
    ...
    fn transition_to_request_phase(
        ...
        let transition_data = PhaseTransitionData {
            board_id,
            new_game_state: GameState::Request,
            top_tile,
            commited_tile,
        };
    ...
    fn transition_to_creating_phase(
        ...
        let transition_data = PhaseTransitionData {
            board_id,
            new_game_state: GameState::Creating,
            top_tile,
            commited_tile,
        };
