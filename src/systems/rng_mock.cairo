...
pub use evolute_duel::systems::rng::{IRngDispatcher, IRngDispatcherTrait};
pub use evolute_duel::types::shuffler::{Shuffler, ShufflerTrait};
...
pub mod rng_mock {
    ...
    use evolute_duel::systems::rng::{IRng};
