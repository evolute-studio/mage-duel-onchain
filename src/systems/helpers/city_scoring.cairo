...
use evolute_duel::{
    ...
    systems::helpers::{
        city_union_find::{
        find, union, convert_board_position_to_city_node_position        },
        board::{},
    },
    packing::{TEdge, Tile, PlayerSide},
};
...
pub fn connect_edges_in_tile(
    ...
    for i in 0..4_u8 {
        if *extended_tile.edges.at(i.into()) == (TEdge::C).into() {
            ...
            let position = convert_board_position_to_city_node_position(tile_position, i);
...
-> Option<(PlayerSide, u32)>{
    ...
    if row != 0 && *edges.at(2) == TEdge::C {
        let edge_pos = convert_board_position_to_city_node_position(tile_position, 2);
        let down_edge_pos = convert_board_position_to_city_node_position(tile_position - 1, 0);
    ...
    if row != 7 && *edges.at(0) == TEdge::C {
        let edge_pos = convert_board_position_to_city_node_position(tile_position, 0);
        let up_edge_pos = convert_board_position_to_city_node_position(tile_position + 1, 2);
    ...
    if col != 0 && *edges.at(3) == TEdge::C {
        let edge_pos = convert_board_position_to_city_node_position(tile_position, 3);
        let left_edge_pos = convert_board_position_to_city_node_position(tile_position - 8, 1);
    ...
    if col != 7 && *edges.at(1) == TEdge::C {
        let edge_pos = convert_board_position_to_city_node_position(tile_position, 1);
        let right_edge_pos = convert_board_position_to_city_node_position(tile_position + 8, 3);
...
mod tests {
    ...
    fn test_connect_edges_in_tile() {
        ...
        let base_pos = convert_board_position_to_city_node_position(tile_position, 0);
       ...
       //println!("Root2: {:?}", city_node);
        ...
        for i in 0..4_u8 {
            ...
            let edge_pos = convert_board_position_to_city_node_position(tile_position, i);
            assert_eq!(
    ...
    #[test]
    fn test_connect_adjacent_edges() {
        ...
        let edge_pos_1 = convert_board_position_to_city_node_position(tile_position_1, 1);
        let edge_pos_2 = convert_board_position_to_city_node_position(tile_position_2, 3);
    ...
    #[test]
    fn test_connect_adjacent_edges_contest() {
        // Инициализация тестового окружения
        let caller = starknet::contract_address_const::<0x0>();
        let ndef = namespace_def();
        ...
        let root1 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_1, 0));
       ...
       //println!("Root1: {:?}", root1);
        ...
        let root2 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_2, 1));
       ...
       //println!("Root2: {:?}", root2);
        ...
        let root3 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_3, 2));
       ...
       //println!("Root3: {:?}", root3);
        ...
        let root4 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_4, 3));
       ...
       //println!("Root4: {:?}", root4);
        ...
        let rot1 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_1, 0));
       //println!("Rot1: {:?}", rot1);
        ...
        let rot2 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_2, 1));
       //println!("Rot2: {:?}", rot2);
        ...
        let rot3 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_3, 2));
       //println!("Rot3: {:?}", rot3);
        ...
        let rot4 = find(ref world, board_id, convert_board_position_to_city_node_position(tile_position_4, 3));
       //println!("Rot4: {:?}", rot4);
        ...
        // Проверяем, что соединены соответствующие края
        // 1 and 2
        let edge_pos_1 = convert_board_position_to_city_node_position(tile_position_1, 0);
        let edge_pos_2 = convert_board_position_to_city_node_position(tile_position_2, 2);
        ...
        // 2 and 3
        let edge_pos_2 = convert_board_position_to_city_node_position(tile_position_2, 1);
        let edge_pos_3 = convert_board_position_to_city_node_position(tile_position_3, 3);
        ...
        // 3 and 4
        let edge_pos_3 = convert_board_position_to_city_node_position(tile_position_3, 2);
        let edge_pos_4 = convert_board_position_to_city_node_position(tile_position_4, 0);
        ...
        // 4 and 1
        let edge_pos_4 = convert_board_position_to_city_node_position(tile_position_4, 3);
        let edge_pos_1 = convert_board_position_to_city_node_position(tile_position_1, 1);
