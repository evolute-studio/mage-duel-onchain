...
pub fn convert_board_position_to_city_node_position(state_tile_position: u8, direction: u8) -> u8 {
...
pub fn convert_city_node_position_to_board_position(city_node_position: u8) -> (u8, u8) {
