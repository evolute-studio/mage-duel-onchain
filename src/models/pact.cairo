...
use evolute_duel::types::errors::duel::{Errors as DuelErrors};
...
mod unit {
    ...
    use super::{PactTrait};
    use evolute_duel::models::duelist::{DuelistStatus, DuelistStatusTrait};
    use evolute_duel::utils::short_string::{ShortString};
    use evolute_duel::utils::misc::{ContractAddressIntoU256};
