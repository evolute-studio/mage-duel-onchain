...
pub impl BitwiseU8 of BitwiseTrait<u8> {
    ...
    fn bit_fill(n: usize) -> u8 {
        if (n == 0) {
            (0)
        } else if (n >= Self::bit_count()) {
            (Self::max())
        } else {
            (Self::shr(Self::max(), Self::bit_count() - n))
        }
    }
    #[inline(always)]
...
pub impl BitwiseU16 of BitwiseTrait<u16> {
    ...
    fn bit(n: usize) -> u16 {
        if n < 8 {
            (BitwiseU8::bit(n).into())
        } else if n < 16 {
            (BitwiseU8::bit(n - 8).into() * 0x100)
        } else {
            (0)
        }
    }
...
pub impl BitwiseU32 of BitwiseTrait<u32> {
    ...
    fn bit(n: usize) -> u32 {
        if n < 16 {
            (BitwiseU16::bit(n).into())
        } else if n < 32 {
            (BitwiseU16::bit(n - 16).into() * 0x10000)
        } else {
            (0)
        }
    }
...
pub impl BitwiseU64 of BitwiseTrait<u64> {
    ...
    fn bit(n: usize) -> u64 {
        if n < 32 {
            (BitwiseU32::bit(n).into())
        } else if n < 64 {
            (BitwiseU32::bit(n - 32).into() * 0x100000000)
        } else {
            (0)
        }
    }
...
pub impl BitwiseU128 of BitwiseTrait<u128> {
    ...
    fn bit(n: usize) -> u128 {
        if n < 64 {
            (BitwiseU64::bit(n).into())
        } else if n < 128 {
            (BitwiseU64::bit(n - 64).into() * 0x10000000000000000)
        } else {
            (0)
        }
    }
...
pub impl BitwiseU256 of BitwiseTrait<u256> {
    ...
    fn bit(n: usize) -> u256 {
        if n < 128 {
            (u256 { low: BitwiseU128::bit(n), high: 0x0 })
        } else if n < 256 {
            (u256 { low: 0x0, high: BitwiseU128::bit(n - 128) })
        } else {
            (0)
        }
    }
...
#[cfg(test)]
mod unit {
    use super::{BITWISE, BitwiseU8, BitwiseU16, BitwiseU32, BitwiseU64, BitwiseU128, BitwiseU256};
    ...
    fn test_set_u8() {
        ...
        while (n < 8) {
            ...
            if (shouldBeSet) {
                bitmap = BitwiseU8::unset(bitmap, n);
            } else {
                bitmap = BitwiseU8::set(bitmap, n);
            }
    ...
    fn test_set_u16() {
        ...
        while (n < 16) {
            ...
            if (shouldBeSet) {
                bitmap = BitwiseU16::unset(bitmap, n);
            } else {
                bitmap = BitwiseU16::set(bitmap, n);
            }
    ...
    fn test_set_u32() {
        ...
        while (n < 32) {
            ...
            if (shouldBeSet) {
                bitmap = BitwiseU32::unset(bitmap, n);
            } else {
                bitmap = BitwiseU32::set(bitmap, n);
            }
    ...
    fn test_set_u64() {
        ...
        while (n < 64) {
            ...
            if (shouldBeSet) {
                bitmap = BitwiseU64::unset(bitmap, n);
            } else {
                bitmap = BitwiseU64::set(bitmap, n);
            }
    ...
    fn test_set_u128() {
        ...
        while (n < 128) {
            ...
            if (shouldBeSet) {
                bitmap = BitwiseU128::unset(bitmap, n);
            } else {
                bitmap = BitwiseU128::set(bitmap, n);
            }
    ...
    fn test_set_u256() {
        ...
        while (n < 256) {
            ...
            if (shouldBeSet) {
                bitmap = BitwiseU256::unset(bitmap, n);
            } else {
                bitmap = BitwiseU256::set(bitmap, n);
            }
