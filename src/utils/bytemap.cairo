...
pub impl BytemapU16 of BytemapTrait<u16> {
    ...
    fn get_byte(self: u16, i: usize) -> u16 {
        if (i < Self::byte_count()) {
            ((self / Self::byte_shift(i)) & 0xff)
        } else {
            (0)
        }
    }
...
#[cfg(test)]
mod unit {
    use super::{BytemapU8, BytemapU16, BytemapU32, BytemapU64, BytemapU128, BytemapU256};
    use evolute_duel::utils::bitwise::{BitwiseU64, BitwiseU256, BITWISE};
