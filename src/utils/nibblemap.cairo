...
pub impl DibitmapU8 of DibitmapTrait<u8> {
    ...
    fn get_dibit(self: u8, i: usize) -> u8 {
        if (i < Self::dibit_count()) {
            ((self / Self::dibit_shift(i)) & 0x3)
        } else {
            (0)
        }
    }
...
mod unit {
    use super::{
        DibitmapU8, DibitmapU16, DibitmapU32, DibitmapU64, NibblemapU8, NibblemapU16, NibblemapU32,
        NibblemapU64, NibblemapU128,
    };
    use evolute_duel::utils::bitwise::{BitwiseU32, BitwiseU128, BITWISE};
